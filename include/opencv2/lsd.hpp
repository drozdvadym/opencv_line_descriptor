#ifndef OPENCV_LSD_HPP
#define OPENCV_LSD_HPP
...
class CV_EXPORTS_W LineSegmentDetector : public Algorithm {
  ...
  */
  CV_WRAP virtual void detect(InputArray _image,
                              OutputArray _lines,
   ...
   */
  CV_WRAP virtual int compareSegments(const Size &size,
                                      InputArray lines1,
                                      InputArray lines2,
